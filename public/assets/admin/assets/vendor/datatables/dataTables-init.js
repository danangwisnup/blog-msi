...
$(document).ready(function () {
    ...
    // Menambahkan search dan length pada datatables
    $("#search-table").keyup(function () {
        $("#zero_config").DataTable().search($(this).val()).draw();
    });
    $("#length-table").change(function () {
        $("#zero_config").DataTable().page.len($(this).val()).draw();
    });

    // Menhide search dan length
    $("div.dt-length").hide();
    $("div.dt-search").hide();
});
